...
export default function EmptyState({
    ...
    return (
        <div className="relative overflow-hidden rounded-3xl bg-sf-0 border border-sf-2 p-8 md:p-12 lg:p-16 flex flex-col items-center justify-center text-center group transition-all duration-500 hover:shadow-2xl hover:shadow-brand-soft hover:-translate-y-1">
            ...
            <div className="relative z-10 flex flex-col items-center max-w-md mx-auto">
                ...
                <h3 className="text-2xl md:text-3xl font-display text-tx mb-4 tracking-tight">
                    {title}
                </h3>

                <p className="text-base text-tx-sec leading-relaxed mb-10 font-light">
                    {description}
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                    {actionLabel && actionHref && (
                        <Link
                            href={actionHref}
                            className="group/btn relative overflow-hidden rounded-full bg-text-brand text-sf-0 px-8 py-3.5 text-sm font-medium transition-all duration-300 hover:bg-brand hover:shadow-lg hover:shadow-brand-soft hover:-translate-y-0.5 active:translate-y-0"
                        >
                    ...
                    {secondaryLabel && secondaryHref && (
                        <Link
                            href={secondaryHref}
                            className="px-6 py-3.5 text-sm font-medium text-tx-muted hover:text-tx transition-colors duration-300 underline-offset-4 hover:underline"
                        >
                            {secondaryLabel}
                        </Link>
                    )}
