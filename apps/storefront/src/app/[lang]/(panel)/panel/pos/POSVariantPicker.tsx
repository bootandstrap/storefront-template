    ...
    return (
        <AnimatePresence>
            ...
            >
                ...
                {/* Modal */}
                <motion.div
                    className="relative w-full max-w-lg mx-4 rounded-2xl bg-surface-0 border border-surface-2 shadow-2xl overflow-hidden"
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-surface-2">
                        <div className="flex items-center gap-3 min-w-0">
                            {product.thumbnail ? (
                                ...
                                <img
                                    ...
                                    alt={product.title}
                                    className="w-12 h-12 rounded-xl object-cover border border-surface-2"
                                />
                            ) : (
                                <div className="w-12 h-12 rounded-xl bg-surface-1 flex items-center justify-center">
                        ...
                        <button
                            ...
                            className="w-9 h-9 rounded-lg flex items-center justify-center min-h-[44px] min-w-[44px]
                                       hover:bg-surface-1 text-text-muted hover:text-text-primary
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className={`relative flex flex-col items-center gap-2 p-4 rounded-xl
                                                   ...
                                                   focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:outline-none
                                                   ${isInStock
                                                       ? 'border-surface-2 hover:border-primary/40 hover:bg-primary/3 active:scale-[0.97] cursor-pointer'
                                                       : 'border-surface-2/50 opacity-50 cursor-not-allowed'
                                                   }`}
                                    >
