...
import { FeatureFlagsSchema, PlanLimitsSchema, StoreConfigSchema, AppConfigSchema, TenantStatusSchema, FALLBACK_CONFIG, shouldCircuitSkipFetch, getCachedConfig, setCachedConfig, clearCachedConfig, getRequiredTenantId, isBuildPhase, reportDegradedMode, circuitRecordSuccess, circuitRecordFailure, resetCircuitBreaker, } from '../index';
describe('Shared Package — Exports Alignment', () => {
    ...
    it('all LimitableResource keys exist in PlanLimitsSchema', () => {
        ...
        for (const resource of LIMITABLE_RESOURCES) {
            expect(schemaKeys, `LimitableResource "${resource}" not found in PlanLimitsSchema`).toContain(resource);
        }
...
//# sourceMappingURL=exports-alignment.test.js.map