...
import type { BadgeColors, BadgeTypeToColorMap, BadgeTypes, FlagTypes, IconComponentType, Sizes } from "@/components/ui/badge/badge-types";
import { badgeTypes } from "@/components/ui/badge/badge-types";
...
const withPillTypes = {
    ...
    [badgeTypes.badgeModern]: {
        ...
        styles: {
            gray: {
                root: "bg-brand text-sec ring-brand",
                addon: "text-gray-500",
                addonButton: "hover:bg-utility-gray-100 text-utility-gray-400 hover:text-utility-gray-500",
            },
        },
...
const withBadgeTypes = {
    ...
    [badgeTypes.badgeModern]: {
        common: "size-max flex items-center whitespace-nowrap rounded-md ring-1 ring-inset bg-brand text-sec ring-brand shadow-xs",
