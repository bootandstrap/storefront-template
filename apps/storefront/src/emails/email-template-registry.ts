...
import type { EmailTemplateLoader } from './loaders/types'
import { orderTemplateLoaders } from './loaders/order-loaders'
import { accountTemplateLoaders } from './loaders/account-loaders'
import { engagementTemplateLoaders } from './loaders/engagement-loaders'

// ---------------------------------------------------------------------------
// Lazy imports to avoid bundling all templates when only one is needed
// ---------------------------------------------------------------------------

const templateLoaders: Record<EmailTemplate, EmailTemplateLoader> = {
    ...orderTemplateLoaders,
    ...accountTemplateLoaders,
    ...engagementTemplateLoaders,
}
