...
import { runBns360OrderLifecyclePrimaryJourney } from '@/lib/bns-360/full-system-journeys'
...
export async function POST(req: NextRequest) {
    try {
        ...
        const result = await runBns360OrderLifecyclePrimaryJourney({ tenantId })
        ...
        logger.error('[bns-360-order-lifecycle-primary] Error:', error)
