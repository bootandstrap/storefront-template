...
export type OrderStatus = "pending" | "pending_whatsapp" | "confirmed" | "processing" | "shipped" | "delivered" | "cancelled" | "refunded";
/** Payment statuses */
...
export type AnalyticsEventType = "page_view" | "view_product" | "add_to_cart" | "remove_from_cart" | "checkout_start" | "checkout_complete" | "whatsapp_checkout";
