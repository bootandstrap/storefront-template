...
-- Date: 2026-07-11
--
-- Adds tenant-scoped notification channel/event mappings used by the
-- automation owner panel and Medusa event bridge.
-- ============================================================================
...
COMMENT ON COLUMN public.config.notification_channels IS
    'Tenant-scoped automation channel configuration. Provider secrets must be redacted from evidence.';

COMMENT ON COLUMN public.config.notification_events IS
    'Tenant-scoped event to notification-channel mapping for automation journeys.';
