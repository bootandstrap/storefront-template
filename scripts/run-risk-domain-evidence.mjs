...
const SAFE_ENV_DEFAULTS = {
  ...
  BNS_360_BASE_URL: 'http://127.0.0.1:3100',
  BNS_RUNTIME_REQUIRE_INTERACTIVE_STATES: '1',
  BNS_RUNTIME_REQUIRE_ORDER_LOOKUP_STATES: '1',
  BNS_RUNTIME_REQUIRE_CHECKOUT_STATES: '1',
  BNS_RUNTIME_REQUIRE_CART_STATES: '1',
  BNS_RUNTIME_LOCAL_FIXTURE_ORIGIN: 'http://127.0.0.1:3101',
  NEXT_PUBLIC_SUPABASE_URL: 'http://127.0.0.1:3101',
  NEXT_PUBLIC_SUPABASE_ANON_KEY: 'local-assurance-public-anon',
  NEXT_PUBLIC_MEDUSA_BACKEND_URL: 'http://127.0.0.1:3101',
  NEXT_PUBLIC_MEDUSA_PUBLISHABLE_KEY: 'local-assurance-public-key',
  NEXT_PUBLIC_STORE_URL: 'https://placeholder.com',
  MEDUSA_BACKEND_URL: 'http://127.0.0.1:3101',
}
