        ...
        functionalEvidence: [
            {
                ...
                target: 'Execute a reversible backup, restore it, re-snapshot the disposable tenant, compare exact governed digests, then delete both backup artifacts',
                reversible: true,
                scope: 'live_mutation',
                gate: 'owner_auth',
                ...
                expectedJsonPaths: [
                    ...
                    'runtime.equivalence.afterDigest',
                    'runtime.equivalence.recordsBefore',
                    'runtime.equivalence.recordsAfter',
                    'runtime.equivalence.constraintsVerified',
                    'runtime.equivalence.tenantScopeViolations',
                    'runtime.codeData.codeRevisionUnchanged',
                    'runtime.codeData.sourceDataMixedWithCode',
                    'runtime.codeData.backupsRestored',
                    'cleanup.status',
                    'residue.zero',
                ],
                expectedJsonValues: {
                    ...
                    'runtime.equivalence.tenantScopeViolations': 0,
                    'runtime.codeData.codeRevisionUnchanged': true,
                    'runtime.codeData.sourceDataMixedWithCode': false,
                    'runtime.codeData.backupsRestored': 1,
                    'cleanup.status': 'verified',
                    'residue.zero': true,
                },
                receiptJsonPaths: [
