...
export default function POSCustomerModal({ onClose, onSelect, labels }: POSCustomerModalProps) {
    ...
    return (
        ...
        >
            <div className="bg-surface-0 rounded-2xl shadow-2xl w-full max-w-md mx-4 max-h-[85vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95">
                {/* Header */}
                ...
                {!showCreate ? (
                    <>
                        ...
                        <div className="px-5 pt-4 pb-2">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-surface-1 border border-surface-2
                        ...
                        <div className="flex-1 overflow-y-auto px-5 pb-4 space-y-1">
                            ...
                            {query.length >= 2 && results.length > 0 && results.map(c => (
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-left
                                               hover:bg-surface-1 transition-colors group"
                                >
                            ...
                            {query.length < 2 && recent.length > 0 && (
                                <>
                                    <p className="text-[11px] font-medium text-text-muted uppercase tracking-wider px-1 pt-2 pb-1">
                    ...
                    <div className="p-5 space-y-3">
                        <p className="text-sm font-medium text-text-primary flex items-center gap-2 mb-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="text-[11px] font-medium text-text-muted block mb-1">{posLabel('panel.pos.firstName', labels)} *</label>
                                <input
                                    type="text"
                                    value={firstName}
                            ...
                            <div>
                                <label className="text-[11px] font-medium text-text-muted block mb-1">{posLabel('panel.pos.lastName', labels)}</label>
                                <input
                                    type="text"
                                    value={lastName}
                        ...
                        <div>
                            <label className="text-[11px] font-medium text-text-muted block mb-1 flex items-center gap-1">
                        ...
                        <div className="flex gap-2 pt-2">
                            <button
                                ...
                                className="flex-1 py-2.5 rounded-xl bg-surface-1 text-text-secondary
                                           text-sm font-medium hover:bg-surface-2 transition-colors"
                            >
