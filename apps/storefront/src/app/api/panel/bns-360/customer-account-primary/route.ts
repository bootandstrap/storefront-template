...
import { runBns360CustomerAccountPrimaryJourney } from '@/lib/bns-360/full-system-journeys'
...
export async function POST(req: NextRequest) {
    try {
        ...
        const result = await runBns360CustomerAccountPrimaryJourney({ tenantId })
        ...
        logger.error('[bns-360-customer-account-primary] Error:', error)
